...
window.onload = function() {
    ...
    function preload()
    {
        ...
        game.load.audio('shuffle', 'assets/shuffle.mp3');
        game.load.audio('draw', 'assets/draw.mp3');
    ...
    function shuffleDeck(array)
    {
        ...
        let shufflysound = game.add.audio('shuffle');
        shufflysound.volume = 0.4;
        shufflysound.play();
        return array;
    }
    ...
    function drawCards()
    {
        ...
        for(let i = 0; i < 4; i++)
        {
            ...
            game.time.events.add(500 * i, function() {
                ...
                let drawsound = game.add.audio('draw');
